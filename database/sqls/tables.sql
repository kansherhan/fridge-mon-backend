...
CREATE TABLE "fridge_measurements" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
ALTER TABLE "fridge_templates" ADD FOREIGN KEY ("company_id") REFERENCES "companies" ("id");

ALTER TABLE "fridge_measurements" ADD FOREIGN KEY ("fridge_id") REFERENCES "fridges" ("id");
